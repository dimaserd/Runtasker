...
using oksoft.Common.HtmlExtensions.Static;
using System;
...
namespace oksoft.Common.HtmlExtensions.Extensions
{
    public static partial class HtmlExtensions
    {
           ...
           Expression<Func<TModel, TValue>> expression, object htmlAttributes = null)
        {
            ...
            .Append(GetStrongErrorTextFor(html, expression));
            ...
            Expression<Func<TModel, TValue>> expression, IEnumerable<SelectListItem> selectList, object htmlAttributes = null)
        {
            ...
            sb.Append(html.DropDownListFor(expression, selectList, new { id = PropertyNameHelper.GetIdForInput(GetNameFromProperty(html, expression)), @class = "form-control" })
                .ToString().WrapToHtmlTag("div", new { @class = "col-md-10 col-sm-10" }));
        ...
        public static MvcHtmlString LabelAndDropDownList(this HtmlHelper html,
            string name, string labelName, IEnumerable<SelectListItem> selectList, object htmlAttributes = null)
        {
            StringBuilder sb = new StringBuilder();

            sb.Append($"<div id=\"{PropertyNameHelper.GetIdForForm(name)}\" class=\"form-group\">");

            sb.Append(html.Label(labelName).ToString().WrapToHtmlTag("div", new { @class = "col-md-2 col-sm-2" }));


            //соглашение по именованию для полей для создания джаваскрипт функций
            sb.Append(html.DropDownList(name, selectList, new { id = PropertyNameHelper.GetIdForInput(name), @class = "form-control" })
                .ToString().WrapToHtmlTag("div", new { @class = "col-md-10 col-sm-10" }));
            ...
            Expression<Func<TModel, TValue>> expression, object htmlAttributes = null)
        {
            ...
            //соглашение по именованию для полей для создания джаваскрипт функций
            sb.Append(html.GetTextBoxWithStrongErrorTextFor(expression, new
            {
            ...
            Expression<Func<TModel, TValue>> expression, object htmlAttributes = null)
        {
            ...
            .Append(html.GetStrongErrorTextFor(expression));
        ...
        /// <param name="expression"></param>
        /// <returns></returns>
        public static MvcHtmlString GetStrongErrorTextFor<TModel, TValue>(this HtmlHelper<TModel> html,
