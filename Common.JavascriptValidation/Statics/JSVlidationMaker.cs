    ...
    public static class JSValidationMaker
    {
        ...
        public static ScriptsForProperty GetJSValidationFuncsForProperty(string propertyName, object[] attrs)
        {
            ...
            foreach(object attr in attrs)
            {
                ...
                else if(attr is HideByDeafaultAttribute)
                {
                    DefaultScripts.Add(GetHideByDefaultScript(propertyName, attr as HideByDeafaultAttribute));
                }
        ...
        private static string GetHideByDefaultScript(string propName, HideByDeafaultAttribute attr)
        {
            StringBuilder sb = new StringBuilder();
