...
namespace Runtasker.Resources.Views.Landing.AboutUs {
    ...
    public class AboutUsRes {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Runtasker – это мультиязычное веб-приложение, мы постоянно стремимся к добавлению новых языков. Нам важно, что бы наши заказчики при взаимодействии с нами чувствовали себя максимально комфортно. А что может быть более удобным, чем общение на родном языке?.
        /// </summary>
